...
export default function LiveCameraAnalyticsCards() {
  ...
  // Gender analytics
  const maleCount = currentDetections.filter(
    ([_, d]) => d.gender === "male" || d.gender === "Male",
  ).length;
  const femaleCount = currentDetections.filter(
    ([_, d]) => d.gender === "female" || d.gender === "Female",
  ).length;
    ...
    <>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <Progress
            value={facesPerHour > 100 ? 100 : facesPerHour}
            className="mt-2"
          />
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            {dominantMoodPercent}% of detections
          </p>
